...
export const DiffTools: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4 h-[400px]"><div className="flex flex-col gap-2 h-full"><Label>{t('tool.diff.original')}</Label><TextArea value={diffLeft} onChange={e => setDiffLeft(e.target.value)} className="flex-1 resize-none font-mono text-xs whitespace-pre bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-white" /></div><div className="flex flex-col gap-2 h-full"><Label>{t('tool.diff.changed')}</Label><TextArea value={diffRight} onChange={e => setDiffRight(e.target.value)} className="flex-1 resize-none font-mono text-xs whitespace-pre bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-white" /></div></div>
